...
public class GoogleCloudPlatformPricingCalculator extends AbstractPage{
    ...
    public GoogleCloudPlatformCalculatingResults fillTheForm(int instances){
        driver.switchTo()
        ...
        addToEstimate();
        return new GoogleCloudPlatformCalculatingResults(driver);
    }
    ...
    public void chooseSeries(){
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(seriesField)).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(seriesSelection)).click();
    }

    public void chooseMachineType(){
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(machineTypeField)).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(getMachineTypeSelection)).click();
    }
    ...
    public void addNumberOfGPUs(){
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(numberOfGPUMenu)).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(numberOfGPUSelection)).click();
    }

    public void addGPUTypes() {
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(gpuTypeMenu)).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(gpuTypeSelection)).click();
    }

    public void addLocalSSD(){
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(localSSDMenu)).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(getLocalSSDSelection)).click();
    }

    public void addDataCenterLocation(){
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(datacenterLocationMenu)).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.elementToBeClickable(getDatacenterLocationSelection)).click();
    }

    public void chooseCommittedUsage(){
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(committedUsageMenu)).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(getCommittedUsageSelection)).click();
    }
